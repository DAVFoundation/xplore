...
import { getBlocks as getBlocksCall, getAccounts as getAccountsCall, getTransactions as getTransactionsCall, getEvents as getEventsCall, getLatestBlockNumber as getLatestBlockCall, getTransactionCount as getTransactionCountCall, getMiningStatus as getMiningStatusCall, getRpcServer as getRpcServerCall } from '../lib/blockchain';
...
export const getLatestBlockNumber = createAction('GET_LATEST_BLOCK', getLatestBlockCall);
